...
ALTER TABLE products ADD COLUMN IF NOT EXISTS icon TEXT DEFAULT 'fas fa-box';
ALTER TABLE products ADD COLUMN IF NOT EXISTS gradient TEXT DEFAULT 'linear-gradient(135deg, #e94560, #d63851)';
